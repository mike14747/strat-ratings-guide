...
export function handleFormSubmit(event, uploadFilename, url) {
    return __awaiter(this, void 0, void 0, function () {
        var messageElement, fileUpload, form, file, fileErrorMessage, formData, dataJSON;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    file = (_a = fileUpload.files) === null || _a === void 0 ? void 0 : _a[0];
                    fileErrorMessage = '';
                    if (!file) {
                    ...
                    return [4 /*yield*/, fetch(url, {
                            method: 'POST',
                            body: formData,
                        }).then(function (res) { return res.json(); }).catch(function (error) { return console.error(error); })];
                case 1:
                    dataJSON = _b.sent();
