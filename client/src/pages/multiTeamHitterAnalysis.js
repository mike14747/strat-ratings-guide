...
function MultiTeamHitterAnalysis() {
    ...
    useEffect(() => {
        axios.get('/api/hitters/multi-team-season-list')
            .then(response => {
    ...
    useEffect(() => {
        if (querySeason) {
            axios.get(`/api/hitters/multi-team/${querySeason}`)
        ...
        <>
            <div className="row mb-4 bg-gray5 border-bottom border-secondary">
                <div className="col-sm-6 text-left">
                    <PageHeading text="Multi-team Hitter Analysis" />
                </div>
...
export default MultiTeamHitterAnalysis;
